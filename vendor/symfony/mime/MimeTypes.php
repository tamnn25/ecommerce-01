...
final class MimeTypes implements MimeTypesInterface
{
    ...
    private const MAP = [
        ...
        'application/$.1000minds.decision-model+xml' => ['1km'],
        'application/$.3gpp.pic-bw-large' => ['plb'],
        'application/$.3gpp.pic-bw-small' => ['psb'],
        'application/$.3gpp.pic-bw-var' => ['pvb'],
        'application/$.3gpp2.tcap' => ['tcap'],
        'application/$.3m.post-it-notes' => ['pwn'],
        'application/$.accpac.simply.aso' => ['aso'],
        'application/$.accpac.simply.imp' => ['imp'],
        'application/$.acucobol' => ['acu'],
        'application/$.acucorp' => ['atc', 'acutc'],
        'application/$.adobe.air-application-installer-package+zip' => ['air'],
        'application/$.adobe.flash.movie' => ['swf', 'spl'],
        'application/$.adobe.formscentral.fcdt' => ['fcdt'],
        'application/$.adobe.fxp' => ['fxp', 'fxpl'],
        'application/$.adobe.illustrator' => ['ai'],
        'application/$.adobe.xdp+xml' => ['xdp'],
        'application/$.adobe.xfdf' => ['xfdf'],
        'application/$.ahead.space' => ['ahead'],
        'application/$.airzip.filesecure.azf' => ['azf'],
        'application/$.airzip.filesecure.azs' => ['azs'],
        'application/$.amazon.ebook' => ['azw'],
        'application/$.amazon.mobi8-ebook' => ['azw3', 'kfx'],
        'application/$.americandynamics.acc' => ['acc'],
        'application/$.amiga.ami' => ['ami'],
        'application/$.android.package-archive' => ['apk'],
        'application/$.anser-web-certificate-issue-initiation' => ['cii'],
        'application/$.anser-web-funds-transfer-initiation' => ['fti'],
        'application/$.antix.game-component' => ['atx'],
        'application/$.appimage' => ['appimage'],
        'application/$.apple.installer+xml' => ['mpkg'],
        'application/$.apple.keynote' => ['key', 'keynote'],
        'application/$.apple.mpegurl' => ['m3u8', 'm3u'],
        'application/$.apple.numbers' => ['numbers'],
        'application/$.apple.pages' => ['pages'],
        'application/$.apple.pkpass' => ['pkpass'],
        'application/$.aristanetworks.swi' => ['swi'],
        'application/$.astraea-software.iota' => ['iota'],
        'application/$.audiograph' => ['aep'],
        'application/$.balsamiq.bmml+xml' => ['bmml'],
        'application/$.blueice.multipass' => ['mpm'],
        'application/$.bmi' => ['bmi'],
        'application/$.businessobjects' => ['rep'],
        'application/$.chemdraw+xml' => ['cdxml'],
        'application/$.chess-pgn' => ['pgn'],
        'application/$.chipnuts.karaoke-mmd' => ['mmd'],
        'application/$.cinderella' => ['cdy'],
        'application/$.citationstyles.style+xml' => ['csl'],
        'application/$.claymore' => ['cla'],
        'application/$.cloanto.rp9' => ['rp9'],
        'application/$.clonk.c4group' => ['c4g', 'c4d', 'c4f', 'c4p', 'c4u'],
        'application/$.cluetrust.cartomobile-config' => ['c11amc'],
        'application/$.cluetrust.cartomobile-config-pkg' => ['c11amz'],
        'application/$.coffeescript' => ['coffee'],
        'application/$.comicbook+zip' => ['cbz'],
        'application/$.comicbook-rar' => ['cbr'],
        'application/$.commonspace' => ['csp'],
        'application/$.contact.cmsg' => ['cdbcmsg'],
        'application/$.corel-draw' => ['cdr'],
        'application/$.cosmocaller' => ['cmc'],
        'application/$.crick.clicker' => ['clkx'],
        'application/$.crick.clicker.keyboard' => ['clkk'],
        'application/$.crick.clicker.palette' => ['clkp'],
        'application/$.crick.clicker.template' => ['clkt'],
        'application/$.crick.clicker.wordbank' => ['clkw'],
        'application/$.criticaltools.wbs+xml' => ['wbs'],
        'application/$.ctc-posml' => ['pml'],
        'application/$.cups-ppd' => ['ppd'],
        'application/$.curl.car' => ['car'],
        'application/$.curl.pcurl' => ['pcurl'],
        'application/$.dart' => ['dart'],
        'application/$.data-vision.rdz' => ['rdz'],
        'application/$.dbf' => ['dbf'],
        'application/$.debian.binary-package' => ['deb', 'udeb'],
        ...
        'application/$.emusic-emusic_package' => ['emp'],
        ...
        'application/$.eszigno3+xml' => ['es3', 'et3'],
        'application/$.etsi.asic-e+zip' => ['asice'],
        'application/$.ezpix-album' => ['ez2'],
        'application/$.ezpix-package' => ['ez3'],
        'application/$.fdf' => ['fdf'],
        'application/$.fdsn.mseed' => ['mseed'],
        'application/$.fdsn.seed' => ['seed', 'dataless'],
        'application/$.flatpak' => ['flatpak', 'xdgapp'],
        'application/$.flatpak.ref' => ['flatpakref'],
        'application/$.flatpak.repo' => ['flatpakrepo'],
        'application/$.flographit' => ['gph'],
        'application/$.fluxtime.clip' => ['ftc'],
        'application/$.framemaker' => ['fm', 'frame', 'maker', 'book'],
        'application/$.frogans.fnc' => ['fnc'],
        'application/$.frogans.ltf' => ['ltf'],
        'application/$.fsc.weblaunch' => ['fsc'],
        'application/$.fujitsu.oasys' => ['oas'],
        'application/$.fujitsu.oasys2' => ['oa2'],
        'application/$.fujitsu.oasys3' => ['oa3'],
        'application/$.fujitsu.oasysgp' => ['fg5'],
        'application/$.fujitsu.oasysprs' => ['bh2'],
        'application/$.fujixerox.ddd' => ['ddd'],
        'application/$.fujixerox.docuworks' => ['xdw'],
        'application/$.fujixerox.docuworks.binder' => ['xbd'],
        'application/$.fuzzysheet' => ['fzs'],
        'application/$.genomatix.tuxedo' => ['txd'],
        'application/$.geo+json' => ['geojson', 'geo.json'],
        'application/$.geogebra.file' => ['ggb'],
        'application/$.geogebra.tool' => ['ggt'],
        'application/$.geometry-explorer' => ['gex', 'gre'],
        'application/$.geonext' => ['gxt'],
        'application/$.geoplan' => ['g2w'],
        'application/$.geospace' => ['g3w'],
        'application/$.gmx' => ['gmx'],
        'application/$.google-apps.document' => ['gdoc'],
        'application/$.google-apps.presentation' => ['gslides'],
        'application/$.google-apps.spreadsheet' => ['gsheet'],
        'application/$.google-earth.kml+xml' => ['kml'],
        'application/$.google-earth.kmz' => ['kmz'],
        'application/$.grafeq' => ['gqf', 'gqs'],
        'application/$.groove-account' => ['gac'],
        'application/$.groove-help' => ['ghf'],
        'application/$.groove-identity-message' => ['gim'],
        'application/$.groove-injector' => ['grv'],
        'application/$.groove-tool-message' => ['gtm'],
        'application/$.groove-tool-template' => ['tpl'],
        'application/$.groove-vcard' => ['vcg'],
        'application/$.haansoft-hwp' => ['hwp'],
        'application/$.haansoft-hwt' => ['hwt'],
        'application/$.hal+xml' => ['hal'],
        'application/$.handheld-entertainment+xml' => ['zmm'],
        'application/$.hbci' => ['hbci'],
        'application/$.hhe.lesson-player' => ['les'],
        'application/$.hp-hpgl' => ['hpgl'],
        'application/$.hp-hpid' => ['hpid'],
        'application/$.hp-hps' => ['hps'],
        'application/$.hp-jlyt' => ['jlt'],
        'application/$.hp-pcl' => ['pcl'],
        'application/$.hp-pclxl' => ['pclxl'],
        'application/$.hydrostatix.sof-data' => ['sfd-hdstx'],
        'application/$.ibm.minipay' => ['mpy'],
        'application/$.ibm.modcap' => ['afp', 'listafp', 'list3820'],
        'application/$.ibm.rights-management' => ['irm'],
        'application/$.ibm.secure-container' => ['sc'],
        'application/$.iccprofile' => ['icc', 'icm'],
        'application/$.igloader' => ['igl'],
        'application/$.immervision-ivp' => ['ivp'],
        'application/$.immervision-ivu' => ['ivu'],
        'application/$.insors.igm' => ['igm'],
        'application/$.intercon.formnet' => ['xpw', 'xpx'],
        'application/$.intergeo' => ['i2g'],
        'application/$.intu.qbo' => ['qbo'],
        'application/$.intu.qfx' => ['qfx'],
        'application/$.ipunplugged.rcprofile' => ['rcprofile'],
        'application/$.irepository.package+xml' => ['irp'],
        'application/$.is-xpr' => ['xpr'],
        'application/$.isac.fcs' => ['fcs'],
        'application/$.jam' => ['jam'],
        'application/$.jcp.javame.midlet-rms' => ['rms'],
        'application/$.jisp' => ['jisp'],
        'application/$.joost.joda-archive' => ['joda'],
        'application/$.kahootz' => ['ktz', 'ktr'],
        ...
        'application/$.lotus-1-2-3' => ['123', 'wk1', 'wk3', 'wk4', 'wks'],
        ...
        'application/$.lotus-wordpro' => ['lwp'],
        'application/$.macports.portpkg' => ['portpkg'],
        'application/$.mcd' => ['mcd'],
        'application/$.medcalcdata' => ['mc1'],
        'application/$.mediastation.cdkey' => ['cdkey'],
        'application/$.mfer' => ['mwf'],
        'application/$.mfmp' => ['mfm'],
        'application/$.micrografx.flo' => ['flo'],
        'application/$.micrografx.igx' => ['igx'],
        'application/$.mif' => ['mif'],
        'application/$.mobius.daf' => ['daf'],
        'application/$.mobius.dis' => ['dis'],
        'application/$.mobius.mbk' => ['mbk'],
        'application/$.mobius.mqy' => ['mqy'],
        'application/$.mobius.msl' => ['msl'],
        'application/$.mobius.plc' => ['plc'],
        'application/$.mobius.txf' => ['txf'],
        'application/$.mophun.application' => ['mpn'],
        'application/$.mophun.certificate' => ['mpc'],
        ...
        'application/$.ms-excel' => ['xls', 'xlm', 'xla', 'xlc', 'xlt', 'xlw', 'xll', 'xld'],
        ...
        'application/$.ms-outlook' => ['msg'],
        'application/$.ms-pki.seccat' => ['cat'],
        'application/$.ms-pki.stl' => ['stl'],
        'application/$.ms-powerpoint' => ['ppt', 'pps', 'pot', 'ppz'],
        ...
        'application/$.ms-tnef' => ['tnef', 'tnf'],
        'application/$.ms-visio.drawing.macroenabled.main+xml' => ['vsdm'],
        'application/$.ms-visio.drawing.main+xml' => ['vsdx'],
        'application/$.ms-visio.stencil.macroenabled.main+xml' => ['vssm'],
        'application/$.ms-visio.stencil.main+xml' => ['vssx'],
        'application/$.ms-visio.template.macroenabled.main+xml' => ['vstm'],
        'application/$.ms-visio.template.main+xml' => ['vstx'],
        ...
        'application/$.ms-works' => ['wps', 'wks', 'wcm', 'wdb', 'xlr'],
        'application/$.ms-wpl' => ['wpl'],
        'application/$.ms-xpsdocument' => ['xps'],
        'application/$.msaccess' => ['mdb'],
        'application/$.mseq' => ['mseq'],
        'application/$.musician' => ['mus'],
        'application/$.muvee.style' => ['msty'],
        'application/$.mynfc' => ['taglet'],
        'application/$.neurolanguage.nlu' => ['nlu'],
        'application/$.nintendo.snes.rom' => ['sfc', 'smc'],
        'application/$.nitf' => ['ntf', 'nitf'],
        'application/$.noblenet-directory' => ['nnd'],
        'application/$.noblenet-sealer' => ['nns'],
        'application/$.noblenet-web' => ['nnw'],
        'application/$.nokia.n-gage.ac+xml' => ['ac'],
        'application/$.nokia.n-gage.data' => ['ngdat'],
        'application/$.nokia.n-gage.symbian.install' => ['n-gage'],
        'application/$.nokia.radio-preset' => ['rpst'],
        'application/$.nokia.radio-presets' => ['rpss'],
        'application/$.novadigm.edm' => ['edm'],
        'application/$.novadigm.edx' => ['edx'],
        'application/$.novadigm.ext' => ['ext'],
        'application/$.oasis.docbook+xml' => ['dbk', 'docbook'],
        ...
        'application/$.oasis.opendocument.formula-template' => ['odft', 'otf'],
        'application/$.oasis.opendocument.graphics' => ['odg'],
        'application/$.oasis.opendocument.graphics-flat-xml' => ['fodg'],
        ...
        'application/$.openblox.game+xml' => ['obgx'],
        'application/$.openofficeorg.extension' => ['oxt'],
        'application/$.openstreetmap.data+xml' => ['osm'],
        ...
        'application/$.osgeo.mapguide.package' => ['mgp'],
        'application/$.osgi.dp' => ['dp'],
        'application/$.osgi.subsystem' => ['esa'],
        'application/$.palm' => ['pdb', 'pqa', 'oprc', 'prc'],
        'application/$.pawaafile' => ['paw'],
        'application/$.pg.format' => ['str'],
        'application/$.pg.osasli' => ['ei6'],
        'application/$.picsel' => ['efif'],
        'application/$.pmi.widget' => ['wg'],
        'application/$.pocketlearn' => ['plf'],
        'application/$.powerbuilder6' => ['pbd'],
        'application/$.previewsystems.box' => ['box'],
        'application/$.proteus.magazine' => ['mgz'],
        'application/$.publishare-delta-tree' => ['qps'],
        'application/$.pvi.ptid1' => ['ptid'],
        'application/$.quark.quarkxpress' => ['qxd', 'qxt', 'qwd', 'qwt', 'qxl', 'qxb'],
        'application/$.rar' => ['rar'],
        ...
        'application/$.rn-realmedia' => ['rm', 'rmj', 'rmm', 'rms', 'rmx', 'rmvb'],
        'application/$.rn-realmedia-vbr' => ['rmvb', 'rm', 'rmj', 'rmm', 'rms', 'rmx'],
        ...
        'application/$.smaf' => ['mmf', 'smaf'],
        'application/$.smart.teacher' => ['teacher'],
        'application/$.snap' => ['snap'],
        'application/$.software602.filler.form+xml' => ['fo'],
        'application/$.solent.sdkm+xml' => ['sdkm', 'sdkd'],
        'application/$.spotfire.dxp' => ['dxp'],
        'application/$.spotfire.sfs' => ['sfs'],
        'application/$.sqlite3' => ['sqlite3'],
        'application/$.squashfs' => ['sqsh'],
        'application/$.stardivision.calc' => ['sdc'],
        'application/$.stardivision.chart' => ['sds'],
        'application/$.stardivision.draw' => ['sda'],
        'application/$.stardivision.impress' => ['sdd', 'sdp'],
        'application/$.stardivision.mail' => ['smd'],
        'application/$.stardivision.math' => ['smf'],
        'application/$.stardivision.writer' => ['sdw', 'vor', 'sgl'],
        'application/$.stardivision.writer-global' => ['sgl', 'sdw', 'vor'],
        'application/$.stepmania.package' => ['smzip'],
        'application/$.stepmania.stepchart' => ['sm'],
        'application/$.sun.wadl+xml' => ['wadl'],
        'application/$.sun.xml.base' => ['odb'],
        ...
        'application/$.syncml.dmddf+xml' => ['ddf'],
        ...
        'application/$.xdgapp' => ['flatpak', 'xdgapp'],
        'application/$.xfdl' => ['xfdl'],
        'application/$.yamaha.hv-dic' => ['hvd'],
        'application/$.yamaha.hv-script' => ['hvs'],
        'application/$.yamaha.hv-voice' => ['hvp'],
        'application/$.yamaha.openscoreformat' => ['osf'],
        'application/$.yamaha.openscoreformat.osfpvg+xml' => ['osfpvg'],
        'application/$.yamaha.smaf-audio' => ['saf'],
        'application/$.yamaha.smaf-phrase' => ['spf'],
        'application/$.yellowriver-custom-menu' => ['cmp'],
        'application/$.youtube.yt' => ['yt'],
        'application/$.zul' => ['zir', 'zirz'],
        'application/$.zzazz.deck+xml' => ['zaz'],
        ...
        'audio/$.audible.aax' => ['aax'],
        'audio/$.dece.audio' => ['uva', 'uvva'],
        'audio/$.digital-winds' => ['eol'],
        'audio/$.dra' => ['dra'],
        'audio/$.dts' => ['dts'],
        'audio/$.dts.hd' => ['dtshd'],
        'audio/$.lucent.voice' => ['lvp'],
        'audio/$.m-realaudio' => ['ra', 'rax'],
        'audio/$.ms-playready.media.pya' => ['pya'],
        'audio/$.nuera.ecelp4800' => ['ecelp4800'],
        'audio/$.nuera.ecelp7470' => ['ecelp7470'],
        'audio/$.nuera.ecelp9600' => ['ecelp9600'],
        'audio/$.rip' => ['rip'],
        'audio/$.rn-realaudio' => ['ra', 'rax'],
        'audio/$.wave' => ['wav'],
        ...
        'image/$.airzip.accelerator.azv' => ['azv'],
        'image/$.dece.graphic' => ['uvi', 'uvvi', 'uvg', 'uvvg'],
        'image/$.djvu' => ['djvu', 'djv'],
        'image/$.djvu+multipage' => ['djvu', 'djv'],
        ...
        'image/$.pco.b16' => ['b16'],
        'image/$.rn-realpix' => ['rp'],
        'image/$.tencent.tap' => ['tap'],
        'image/$.valve.source.texture' => ['vtf'],
        'image/$.wap.wbmp' => ['wbmp'],
        'image/$.xiff' => ['xif'],
        'image/$.zbrush.pcx' => ['pcx'],
        'image/webp' => ['webp'],
        'image/wmf' => ['wmf'],
        'image/x-3ds' => ['3ds'],
        ...
        'model/$.mts' => ['mts'],
        'model/$.opengex' => ['ogex'],
        'model/$.parasolid.transmit.binary' => ['x_b'],
        'model/$.parasolid.transmit.text' => ['x_t'],
        'model/$.sap.vds' => ['vds'],
        'model/$.usdz+zip' => ['usdz'],
        'model/$.valve.source.compiled-map' => ['bsp'],
        'model/$.vtu' => ['vtu'],
        ...
        'text/$.graphviz' => ['gv', 'dot'],
        'text/$.in3d.3dml' => ['3dml'],
        'text/$.in3d.spot' => ['spot'],
        'text/$.qt.linguist' => ['ts'],
        'text/$.rn-realtext' => ['rt'],
        'text/$.senx.warpscript' => ['mc2'],
        'text/$.sun.j2me.app-descriptor' => ['jad'],
        'text/$.trolltech.linguist' => ['ts'],
        'text/$.wap.wml' => ['wml'],
        ...
        'video/$.dvb.file' => ['dvb'],
        'video/$.fvt' => ['fvt'],
        'video/$.mpegurl' => ['mxu', 'm4u', 'm1u'],
        'video/$.ms-playready.media.pyv' => ['pyv'],
        'video/$.radgamettools.bink' => ['bik', 'bk2'],
        'video/$.radgamettools.smacker' => ['smk'],
        'video/$.rn-realvideo' => ['rv', 'rvx'],
    ...
    private const REVERSE_MAP = [
        ...
        'aax' => ['audio/$.audible', 'audio/$.audible.aax', 'audio/x-pn-audibleaudio'],
        'abw' => ['application/x-abiword'],
        'abw.CRASHED' => ['application/x-abiword'],
        'abw.gz' => ['application/x-abiword'],
        'ac' => ['application/pkix-attr-cert', 'application/$.nokia.n-gage.ac+xml'],
        'ac3' => ['audio/ac3'],
        ...
        'ai' => ['application/illustrator', 'application/postscript', 'application/$.adobe.illustrator'],
        'aif' => ['audio/x-aiff'],
        ...
        'appimage' => ['application/$.appimage', 'application/x-iso9660-appimage'],
        ...
        'asf' => ['application/$.ms-asf', 'video/x-ms-asf', 'video/x-ms-asf-plugin', 'video/x-ms-wm'],
        ...
        'avf' => ['video/avi', 'video/divx', 'video/msvideo', 'video/$.divx', 'video/x-avi', 'video/x-msvideo'],
        'avi' => ['video/avi', 'video/divx', 'video/msvideo', 'video/$.divx', 'video/x-avi', 'video/x-msvideo'],
        ...
        'azw3' => ['application/$.amazon.mobi8-ebook', 'application/x-mobi8-ebook'],
        'b16' => ['image/$.pco.b16'],
        'bak' => ['application/x-trash'],
        'bat' => ['application/x-msdownload'],
        'bcpio' => ['application/x-bcpio'],
        'bdf' => ['application/x-font-bdf'],
        'bdm' => ['application/$.syncml.dm+wbxml', 'video/mp2t'],
        'bdmv' => ['video/mp2t'],
        'bdoc' => ['application/bdoc', 'application/x-bdoc'],
        'bed' => ['application/$.realvnc.bed'],
        'bh2' => ['application/$.fujitsu.oasysprs'],
        'bib' => ['text/x-bibtex'],
        'bik' => ['video/$.radgamettools.bink'],
        'bin' => ['application/octet-stream'],
        'bk2' => ['video/$.radgamettools.bink'],
        ...
        'cab' => ['application/$.ms-cab-compressed', 'zz-application/zz-winassoc-cab'],
        'caf' => ['audio/x-caf'],
        'cap' => ['application/pcap', 'application/$.tcpdump.pcap', 'application/x-pcap'],
        'car' => ['application/$.curl.car'],
        'cat' => ['application/$.ms-pki.seccat'],
        'cb7' => ['application/x-cb7', 'application/x-cbr'],
        'cba' => ['application/x-cbr'],
        'cbl' => ['text/x-cobol'],
        'cbr' => ['application/$.comicbook-rar', 'application/x-cbr'],
        'cbt' => ['application/x-cbr', 'application/x-cbt'],
        'cbz' => ['application/$.comicbook+zip', 'application/x-cbr', 'application/x-cbz'],
        ...
        'cdr' => ['application/cdr', 'application/coreldraw', 'application/$.corel-draw', 'application/x-cdr', 'application/x-coreldraw', 'image/cdr', 'image/x-cdr', 'zz-application/zz-winassoc-cdr'],
        'cdx' => ['chemical/x-cdx'],
        ...
        'chm' => ['application/$.ms-htmlhelp', 'application/x-chm'],
        'chrt' => ['application/$.kde.kchart', 'application/x-kchart'],
        'cif' => ['chemical/x-cif'],
        ...
        'coffee' => ['application/$.coffeescript', 'text/coffeescript'],
        ...
        'dbf' => ['application/dbase', 'application/dbf', 'application/$.dbf', 'application/x-dbase', 'application/x-dbf'],
        'dbk' => ['application/docbook+xml', 'application/$.oasis.docbook+xml', 'application/x-docbook+xml'],
        ...
        'dds' => ['image/$.ms-dds', 'image/x-dds'],
        'deb' => ['application/$.debian.binary-package', 'application/x-deb', 'application/x-debian-package'],
        'def' => ['text/plain'],
        ...
        'divx' => ['video/avi', 'video/divx', 'video/msvideo', 'video/$.divx', 'video/x-avi', 'video/x-msvideo'],
        'djv' => ['image/$.djvu', 'image/$.djvu+multipage', 'image/x-djvu', 'image/x.djvu'],
        'djvu' => ['image/$.djvu', 'image/$.djvu+multipage', 'image/x-djvu', 'image/x.djvu'],
        'dll' => ['application/x-msdownload'],
        'dmg' => ['application/x-apple-diskimage'],
        'dmp' => ['application/pcap', 'application/$.tcpdump.pcap', 'application/x-pcap'],
        'dna' => ['application/$.dna'],
        'dng' => ['image/x-adobe-dng'],
        'doc' => ['application/msword', 'application/$.ms-word', 'application/x-msword', 'zz-application/zz-winassoc-doc'],
        'docbook' => ['application/docbook+xml', 'application/$.oasis.docbook+xml', 'application/x-docbook+xml'],
        ...
        'dot' => ['application/msword', 'application/msword-template', 'text/$.graphviz'],
        ...
        'dts' => ['audio/$.dts', 'audio/x-dts'],
        'dtshd' => ['audio/$.dts.hd', 'audio/x-dtshd'],
        ...
        'emp' => ['application/$.emusic-emusic_package'],
        ...
        'flatpak' => ['application/$.flatpak', 'application/$.xdgapp'],
        'flatpakref' => ['application/$.flatpak.ref'],
        'flatpakrepo' => ['application/$.flatpak.repo'],
        ...
        'flw' => ['application/$.kde.kivio', 'application/x-kivio'],
        'flx' => ['text/$.fmi.flexstor'],
        'fly' => ['text/$.fly'],
        'fm' => ['application/$.framemaker', 'application/x-frame'],
        'fnc' => ['application/$.frogans.fnc'],
        'fo' => ['application/$.software602.filler.form+xml', 'text/x-xslfo'],
        'fodg' => ['application/$.oasis.opendocument.graphics-flat-xml'],
        'fodp' => ['application/$.oasis.opendocument.presentation-flat-xml'],
        'fods' => ['application/$.oasis.opendocument.spreadsheet-flat-xml'],
        'fodt' => ['application/$.oasis.opendocument.text-flat-xml'],
        'for' => ['text/x-fortran'],
        'fpx' => ['image/$.fpx'],
        ...
        'geo.json' => ['application/geo+json', 'application/$.geo+json'],
        ...
        'hwp' => ['application/$.haansoft-hwp', 'application/x-hwp'],
        'hwt' => ['application/$.haansoft-hwt', 'application/x-hwt'],
        'hxx' => ['text/x-c++hdr'],
        ...
        'icns' => ['image/x-icns'],
        'ico' => ['application/ico', 'image/ico', 'image/icon', 'image/$.microsoft.icon', 'image/x-ico', 'image/x-icon', 'text/ico'],
        ...
        'karbon' => ['application/$.kde.karbon', 'application/x-karbon'],
        'kdbx' => ['application/x-keepass2'],
        'kdc' => ['image/x-kodak-kdc'],
        'kdelnk' => ['application/x-desktop', 'application/x-gnome-app-info'],
        'kexi' => ['application/x-kexiproject-sqlite', 'application/x-kexiproject-sqlite2', 'application/x-kexiproject-sqlite3', 'application/x-$.kde.kexi'],
        'kexic' => ['application/x-kexi-connectiondata'],
        'kexis' => ['application/x-kexiproject-shortcut'],
        'key' => ['application/$.apple.keynote', 'application/pgp-keys', 'application/x-iwork-keynote-sffkey'],
        'keynote' => ['application/$.apple.keynote'],
        'kfo' => ['application/$.kde.kformula', 'application/x-kformula'],
        'kfx' => ['application/$.amazon.mobi8-ebook', 'application/x-mobi8-ebook'],
        ...
        'kon' => ['application/$.kde.kontour', 'application/x-kontour'],
        'kpm' => ['application/x-kpovmodeler'],
        'kpr' => ['application/$.kde.kpresenter', 'application/x-kpresenter'],
        'kpt' => ['application/$.kde.kpresenter', 'application/x-kpresenter'],
        'kpxx' => ['application/$.ds-keypoint'],
        'kra' => ['application/x-krita'],
        'ks' => ['application/x-java-keystore'],
        'ksp' => ['application/$.kde.kspread', 'application/x-kspread'],
        ...
        'kwd' => ['application/$.kde.kword', 'application/x-kword'],
        'kwt' => ['application/$.kde.kword', 'application/x-kword'],
        ...
        'm15' => ['audio/x-mod'],
        'm1u' => ['video/$.mpegurl', 'video/x-mpegurl'],
        'm1v' => ['video/mpeg'],
        ...
        'm2v' => ['video/mpeg'],
        'm3a' => ['audio/mpeg'],
        'm3u' => ['audio/x-mpegurl', 'application/m3u', 'application/$.apple.mpegurl', 'audio/m3u', 'audio/mpegurl', 'audio/x-m3u', 'audio/x-mp3-playlist'],
        'm3u8' => ['application/m3u', 'application/$.apple.mpegurl', 'audio/m3u', 'audio/mpegurl', 'audio/x-m3u', 'audio/x-mp3-playlist', 'audio/x-mpegurl'],
        'm4' => ['application/x-m4'],
        ...
        'm4u' => ['video/$.mpegurl', 'video/x-mpegurl'],
        ...
        'mc2' => ['text/$.senx.warpscript'],
        'mcd' => ['application/$.mcd'],
        'mcurl' => ['text/$.curl.mcurl'],
        'md' => ['text/markdown', 'text/x-markdown'],
        'mdb' => ['application/x-msaccess', 'application/mdb', 'application/msaccess', 'application/$.ms-access', 'application/$.msaccess', 'application/x-mdb', 'zz-application/zz-winassoc-mdb'],
        'mdi' => ['image/$.ms-modi'],
        ...
        'mgp' => ['application/$.osgeo.mapguide.package', 'application/x-magicpoint'],
        ...
        'mif' => ['application/$.mif', 'application/x-mif'],
        'mime' => ['message/rfc822'],
        ...
        'mmf' => ['application/$.smaf', 'application/x-smaf'],
        ...
        'mp4v' => ['video/mp4'],
        'mpc' => ['application/$.mophun.certificate', 'audio/x-musepack'],
        ...
        'mpp' => ['application/$.ms-project', 'audio/x-musepack'],
        ...
        'mxu' => ['video/$.mpegurl', 'video/x-mpegurl'],
        ...
        'numbers' => ['application/$.apple.numbers', 'application/x-iwork-numbers-sffnumbers'],
        ...
        'ocl' => ['text/x-ocl'],
        'oda' => ['application/oda'],
        'odb' => ['application/$.oasis.opendocument.database', 'application/$.sun.xml.base'],
        ...
        'oprc' => ['application/$.palm', 'application/x-palm-database'],
        'opus' => ['audio/ogg', 'audio/x-ogg', 'audio/x-opus+ogg'],
        'ora' => ['image/openraster'],
        'orf' => ['image/x-olympus-orf'],
        'org' => ['application/$.lotus-organizer', 'text/x-org'],
        ...
        'otf' => ['application/$.oasis.opendocument.formula-template', 'application/x-font-otf', 'font/otf'],
        ...
        'pages' => ['application/$.apple.pages', 'application/x-iwork-pages-sffpages'],
        ...
        'pcap' => ['application/pcap', 'application/$.tcpdump.pcap', 'application/x-pcap'],
        ...
        'pcx' => ['image/$.zbrush.pcx', 'image/x-pcx'],
        'pdb' => ['application/$.palm', 'application/x-aportisdoc', 'application/x-palm-database', 'application/x-pilot'],
        ...
        'pgn' => ['application/$.chess-pgn', 'application/x-chess-pgn'],
        ...
        'pot' => ['application/mspowerpoint', 'application/powerpoint', 'application/$.ms-powerpoint', 'application/x-mspowerpoint', 'text/x-gettext-translation-template', 'text/x-pot'],
        ...
        'pps' => ['application/mspowerpoint', 'application/powerpoint', 'application/$.ms-powerpoint', 'application/x-mspowerpoint'],
        ...
        'ppt' => ['application/$.ms-powerpoint', 'application/mspowerpoint', 'application/powerpoint', 'application/x-mspowerpoint'],
        ...
        'ppz' => ['application/mspowerpoint', 'application/powerpoint', 'application/$.ms-powerpoint', 'application/x-mspowerpoint'],
        'pqa' => ['application/$.palm', 'application/x-palm-database'],
        'prc' => ['application/$.palm', 'application/x-mobipocket-ebook', 'application/x-palm-database', 'application/x-pilot'],
        ...
        'psd' => ['application/photoshop', 'application/x-photoshop', 'image/photoshop', 'image/psd', 'image/$.adobe.photoshop', 'image/x-photoshop', 'image/x-psd'],
        ...
        'pub' => ['application/$.ms-publisher', 'application/x-mspublisher'],
        ...
        'ra' => ['audio/$.m-realaudio', 'audio/$.rn-realaudio', 'audio/x-pn-realaudio', 'audio/x-realaudio'],
        'raf' => ['image/x-fuji-raf'],
        'ram' => ['application/ram', 'audio/x-pn-realaudio'],
        'raml' => ['application/raml+yaml'],
        'rapd' => ['application/route-apd+xml'],
        'rar' => ['application/x-rar-compressed', 'application/$.rar', 'application/x-rar'],
        ...
        'rax' => ['audio/$.m-realaudio', 'audio/$.rn-realaudio', 'audio/x-pn-realaudio'],
        ...
        'rle' => ['image/rle'],
        'rm' => ['application/$.rn-realmedia', 'application/$.rn-realmedia-vbr'],
        'rmi' => ['audio/midi'],
        'rmj' => ['application/$.rn-realmedia', 'application/$.rn-realmedia-vbr'],
        'rmm' => ['application/$.rn-realmedia', 'application/$.rn-realmedia-vbr'],
        'rmp' => ['audio/x-pn-realaudio-plugin'],
        'rms' => ['application/$.jcp.javame.midlet-rms', 'application/$.rn-realmedia', 'application/$.rn-realmedia-vbr'],
        'rmvb' => ['application/$.rn-realmedia', 'application/$.rn-realmedia-vbr'],
        'rmx' => ['application/$.rn-realmedia', 'application/$.rn-realmedia-vbr'],
        ...
        'rv' => ['video/$.rn-realvideo', 'video/x-real-video'],
        'rvx' => ['video/$.rn-realvideo', 'video/x-real-video'],
        ...
        'scm' => ['application/$.lotus-screencam', 'text/x-scheme'],
        ...
        'sdp' => ['application/sdp', 'application/$.sdp', 'application/$.stardivision.impress', 'application/x-sdp'],
        'sds' => ['application/$.stardivision.chart'],
        'sdw' => ['application/$.stardivision.writer', 'application/$.stardivision.writer-global'],
        ...
        'sfc' => ['application/$.nintendo.snes.rom', 'application/x-snes-rom'],
        ...
        'sgl' => ['application/$.stardivision.writer', 'application/$.stardivision.writer-global'],
        'sgm' => ['text/sgml'],
        'sgml' => ['text/sgml'],
        ...
        'sisx' => ['application/$.symbian.install', 'x-epoc/x-sisx-app'],
        ...
        'smaf' => ['application/$.smaf', 'application/x-smaf'],
        'smc' => ['application/$.nintendo.snes.rom', 'application/x-snes-rom'],
        'smd' => ['application/$.stardivision.mail', 'application/x-genesis-rom'],
        ...
        'smk' => ['video/$.radgamettools.smacker'],
        ...
        'spl' => ['application/futuresplash', 'application/$.adobe.flash.movie', 'application/x-futuresplash', 'application/x-shockwave-flash'],
        ...
        'sqlite3' => ['application/$.sqlite3', 'application/x-sqlite3'],
        'sqsh' => ['application/$.squashfs'],
        ...
        'stl' => ['application/$.ms-pki.stl', 'model/stl', 'model/x.stl-ascii', 'model/x.stl-binary'],
        'stm' => ['audio/x-stm'],
        ...
        'styl' => ['text/stylus'],
        'stylus' => ['text/stylus'],
        'sub' => ['image/$.dvb.subtitle', 'text/$.dvb.subtitle', 'text/x-microdvd', 'text/x-mpsub', 'text/x-subviewer'],
        ...
        'swf' => ['application/futuresplash', 'application/$.adobe.flash.movie', 'application/x-shockwave-flash'],
        ...
        'tnef' => ['application/ms-tnef', 'application/$.ms-tnef'],
        'tnf' => ['application/ms-tnef', 'application/$.ms-tnef'],
        ...
        'ts' => ['application/x-linguist', 'text/$.qt.linguist', 'text/$.trolltech.linguist', 'video/mp2t'],
        ...
        'udeb' => ['application/$.debian.binary-package', 'application/x-deb', 'application/x-debian-package'],
        ...
        'voc' => ['audio/x-voc'],
        'vor' => ['application/$.stardivision.writer', 'application/$.stardivision.writer-global'],
        'vox' => ['application/x-authorware-bin'],
        'vpc' => ['application/x-vhd-disk', 'application/x-virtualbox-vhd'],
        'vrm' => ['model/vrml'],
        'vrml' => ['model/vrml'],
        'vsd' => ['application/$.visio'],
        'vsdm' => ['application/$.ms-visio.drawing.macroenabled.main+xml'],
        'vsdx' => ['application/$.ms-visio.drawing.main+xml'],
        'vsf' => ['application/$.vsf'],
        'vss' => ['application/$.visio'],
        'vssm' => ['application/$.ms-visio.stencil.macroenabled.main+xml'],
        'vssx' => ['application/$.ms-visio.stencil.main+xml'],
        'vst' => ['application/tga', 'application/$.visio', 'application/x-targa', 'application/x-tga', 'image/targa', 'image/tga', 'image/x-icb', 'image/x-targa', 'image/x-tga'],
        'vstm' => ['application/$.ms-visio.template.macroenabled.main+xml'],
        'vstx' => ['application/$.ms-visio.template.main+xml'],
        ...
        'wav' => ['audio/wav', 'audio/$.wave', 'audio/wave', 'audio/x-wav'],
        ...
        'wk1' => ['application/lotus123', 'application/$.lotus-1-2-3', 'application/wk1', 'application/x-123', 'application/x-lotus123', 'zz-application/zz-winassoc-123'],
        'wk3' => ['application/lotus123', 'application/$.lotus-1-2-3', 'application/wk1', 'application/x-123', 'application/x-lotus123', 'zz-application/zz-winassoc-123'],
        'wk4' => ['application/lotus123', 'application/$.lotus-1-2-3', 'application/wk1', 'application/x-123', 'application/x-lotus123', 'zz-application/zz-winassoc-123'],
        'wkdownload' => ['application/x-partial-download'],
        'wks' => ['application/lotus123', 'application/$.lotus-1-2-3', 'application/$.ms-works', 'application/wk1', 'application/x-123', 'application/x-lotus123', 'zz-application/zz-winassoc-123'],
        'wm' => ['video/x-ms-wm'],
        ...
        'woff2' => ['font/woff2'],
        'wp' => ['application/$.wordperfect', 'application/wordperfect', 'application/x-wordperfect'],
        'wp4' => ['application/$.wordperfect', 'application/wordperfect', 'application/x-wordperfect'],
        'wp5' => ['application/$.wordperfect', 'application/wordperfect', 'application/x-wordperfect'],
        'wp6' => ['application/$.wordperfect', 'application/wordperfect', 'application/x-wordperfect'],
        'wpd' => ['application/$.wordperfect', 'application/wordperfect', 'application/x-wordperfect'],
        'wpg' => ['application/x-wpg'],
        'wpl' => ['application/$.ms-wpl'],
        'wpp' => ['application/$.wordperfect', 'application/wordperfect', 'application/x-wordperfect'],
        'wps' => ['application/$.ms-works'],
        'wqd' => ['application/$.wqd'],
        'wri' => ['application/x-mswrite'],
        'wrl' => ['model/vrml'],
        'ws' => ['application/x-wonderswan-rom'],
        'wsc' => ['application/x-wonderswan-color-rom', 'message/$.wfa.wsc'],
        ...
        'xar' => ['application/$.xara', 'application/x-xar'],
        ...
        'xdgapp' => ['application/$.flatpak', 'application/$.xdgapp'],
        ...
        'xi' => ['audio/x-xi'],
        'xif' => ['image/$.xiff'],
        'xla' => ['application/msexcel', 'application/$.ms-excel', 'application/x-msexcel', 'zz-application/zz-winassoc-xls'],
        'xlam' => ['application/$.ms-excel.addin.macroenabled.12'],
        'xlc' => ['application/msexcel', 'application/$.ms-excel', 'application/x-msexcel', 'zz-application/zz-winassoc-xls'],
        'xld' => ['application/msexcel', 'application/$.ms-excel', 'application/x-msexcel', 'zz-application/zz-winassoc-xls'],
        'xlf' => ['application/x-xliff', 'application/x-xliff+xml', 'application/xliff+xml'],
        'xliff' => ['application/x-xliff', 'application/xliff+xml'],
        'xll' => ['application/msexcel', 'application/$.ms-excel', 'application/x-msexcel', 'zz-application/zz-winassoc-xls'],
        'xlm' => ['application/msexcel', 'application/$.ms-excel', 'application/x-msexcel', 'zz-application/zz-winassoc-xls'],
        'xlr' => ['application/$.ms-works'],
        'xls' => ['application/$.ms-excel', 'application/msexcel', 'application/x-msexcel', 'zz-application/zz-winassoc-xls'],
        ...
        'xlt' => ['application/msexcel', 'application/$.ms-excel', 'application/x-msexcel', 'zz-application/zz-winassoc-xls'],
        'xltm' => ['application/$.ms-excel.template.macroenabled.12'],
        'xltx' => ['application/$.openxmlformats-officedocument.spreadsheetml.template'],
        'xlw' => ['application/msexcel', 'application/$.ms-excel', 'application/x-msexcel', 'zz-application/zz-winassoc-xls'],
        ...
        'xps' => ['application/$.ms-xpsdocument', 'application/xps'],
        ...
        'zz' => ['application/zlib'],
        '123' => ['application/lotus123', 'application/$.lotus-1-2-3', 'application/wk1', 'application/x-123', 'application/x-lotus123', 'zz-application/zz-winassoc-123'],
