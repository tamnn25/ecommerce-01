...
(function (factory) {
  ...
  var excelStrings = {
    ...
    "[Content_Types].xml":
      ...
      '<Default Extension="rels" ContentType="application/$.openxmlformats-package.relationships+xml" />' +
      '<Default Extension="jpeg" ContentType="image/jpeg" />' +
      '<Override PartName="/xl/workbook.xml" ContentType="application/$.openxmlformats-officedocument.spreadsheetml.sheet.main+xml" />' +
      '<Override PartName="/xl/worksheets/sheet1.xml" ContentType="application/$.openxmlformats-officedocument.spreadsheetml.worksheet+xml" />' +
      '<Override PartName="/xl/styles.xml" ContentType="application/$.openxmlformats-officedocument.spreadsheetml.styles+xml" />' +
      "</Types>",
